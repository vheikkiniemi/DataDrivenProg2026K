...
energy_path = Path("2016.csv")         # Your energy CSV with semicolons and comma decimals
weather_path = Path("2016_weather.csv")       # Your weather CSV with commas and dot decimals
output_path = Path("2016_energy_with_temp.csv")
import pandas as pd
...
# Drop the "Daily average temperature"
